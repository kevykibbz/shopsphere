...
$(document).ready(function () {
  ...
  if (document.getElementById("newsletter-popup-form")) {
    // Check if the user has opted to hide the popup
    if (sessionStorage.getItem("hideNewsletterPopup") !== "true") {
      setTimeout(function () {
        var mpInstance = $.magnificPopup.instance;
          ...
          $.magnificPopup.open({
            ...
            callbacks: {
              open: function () {
                ...
                // Add event listener for the "Do not show this popup again" checkbox
                const doNotShowCheckbox =
                  document.getElementById("register-policy-2");
                if (doNotShowCheckbox) {
                  doNotShowCheckbox.addEventListener("change", function () {
                    if (this.checked) {
                      // Store the user's preference in sessionStorage
                      sessionStorage.setItem("hideNewsletterPopup", "true");
                      // Close the popup immediately
                      $.magnificPopup.close();
                    } else {
                      // Remove the preference if the checkbox is unchecked
                      sessionStorage.removeItem("hideNewsletterPopup");
                    }
                  });
                }
              },
